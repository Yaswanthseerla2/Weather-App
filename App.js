...
function App() {
  ...
  const getWeatherIconUrl = (main) => {
    switch (main) {
      case "Clear":
        return "/sun1.png"; // Path to your sunny weather icon
      case "Rain":
        return "/icons/thunder.png"; // Path to your rainy weather icon
      case "Snow":
        return "/icons/Tornado.png"; // Path to your snowy weather icon
      case "Haze":
